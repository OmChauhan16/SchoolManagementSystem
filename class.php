...
<div class="modal" id="myModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body d-flex justify-content-center">
        <input type="text" name="" id="clas" placeholder="Class Name">
      </div>
...
<?php
 include("database.php");
    ...
    $sql= "SELECT * FROM `class_master` INNER JOIN `programs` ON `class_master`.programId=`programs`.id";
